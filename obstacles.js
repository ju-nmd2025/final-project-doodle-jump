function chooseObstacleType() {
  ...
  if (rainbowExists) {
    return random(["balloon","balloon","balloon","balloon","balloon","balloon","balloon","balloon",
...
export default class Obstacle {
  ...
  draw() {
    ...
    if (this.type === "balloon") {
      ...
      fill("blue");
      triangle(-4, this.size / 2 - 2, 4, this.size / 2 - 2, 0, this.size / 2 + 6);
      stroke(180);
      noFill();
      beginShape();
      for (let t = 0; t < 12; t++) vertex(sin(t * 0.5) * 2, this.size / 2 + 6 + t * 3);
      endShape();
      noStroke();
      fill(0);
      ellipse(-5, -3, 3, 3);
